...
With this script, [IMDb](https://www.imdb.com/), [TMDb](https://www.themoviedb.org/), [Kinopoisk](https://www.kinopoisk.ru/), [Letterboxd](https://letterboxd.com/) & [Serializd](https://www.serializd.com/) will become free online cinemas! On each page with a movie or TV series, a flag will appear in the upper left corner. By clicking on it, you will open a player with the movie.
...
3. Install the script by going to [this link](https://github.com/X-49/Tape-Operator-with-Serializd/raw/refs/heads/dev/userscript/tape-operator.user.js). _(or download `tape-operator.user.js` from folder `userscript`) and install manually)_
